        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-8 h-full">
          <div className="rounded-lg bg-gray-100 p-6 shadow-md h-full">
            ...
            <div className="flex justify-between">
              <div className="flex justify-center items-center space-x-2 bg-[#4c6ef5] rounded-lg px-4 py-2 w-1/3 hover:bg-[#503bdb]">
                <UploadIcon className="h-5 w-5 text-white" />
                <Link className="text-white hover:text-gray-50" href="#">
                  Publish
                </Link>
              </div>
